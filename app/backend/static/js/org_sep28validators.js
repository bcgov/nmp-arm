    ...
    fields : { 
        ...
        water_table_depth: { 
            validators : { 
                risk_rating: { 
                    ...
                    caution_values : [
                        { value : 12, message : "Do not apply at this time. There is an elevated water table at this location, which reduces soil infiltration and greatly increases the runoff potential."  } ,
                        { value : 24, message : "Caution: There is an elevated water table at this location, which greatly increases a chance of a runoff event. Tiles may also be running, which can act as a direct conduit for discharge. Consider postponing application."  } ,
                        { value : 48, message : "Be cautious of a rising watertable during high rainfall periods. Watch for ponding in low spots, running tiles, and soil saturation. Consider restricting application rate volume."  } ,
                    ] , 
                    is_reversed : true ,
                } , 
            } , 
        ...
        forage_density : {
            validators : {
                ...
                risk_rating : {
                    values : [ 90, 85, 80, 75, 72, 70, 65, 60, 55, 50] ,
                    caution_values : [ 
                        ...
                        { value : 'forage_density_other', message : "Application of manure to bare soil can be risky during wet times. Check soil moisture, observe application setbacks, and incorporate manure into soil if possible." , risk: 5} ,
                    ] ,
                    is_reversed : true 
                } , 
            }
        ...
        surface_condition : {
            validators : {
                ...
                surface_risk_rating: {
                    ...
                    stop_values : { 'flooding' : true, 'frozen' : true } ,
                    caution_values : [
                        { value : 'ponding', message : "Ponding - Caution: If ponded area or swale leads directly to a waterway, stay back the appropriate seasonal setback distance. If ponded area does not directly discharge to a waterbody, stay back at least 20 feet to avoid field compaction. Ponding can be a sign of a high water table, so be cautious of soil saturation." } ,
