...
window.update_riskrating_ui = function( $field, rating ) {
    ...
    // rupdate( rating, override );
        // KV - calculate total sume here to fix this
        
        total = RATING.precipitation_1  ;  //rating.risk ;
        total2 = RATING.precipitation_2  ;  //rating.risk ;
        console.log( "[ RISK day one]: ", total );
        console.log( "[ TOTAL RISK ]: ", total2 );
        ...
        vegetation_buffer : {
            validators : {
                ...
                risk_rating : {
                    ...
                    caution_values : [ 
                        { value : 22, message : "Caution: If you field is in grass, grass can act like a buffer if it is dense and greater than 3 inches in height. You may change your response to “yes” if in grass. If your field is not in grass, observe seasonal setbacks and consider vegetative buffers if needed."  } ,
